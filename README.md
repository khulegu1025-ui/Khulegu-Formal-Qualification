# Khulegu Tumennast - Academic & Professional Credentials

This repository contains the official documentation of my academic achievements and professional training.
...
## 🏛️ Asia University (Current)
**Degree:** B.S. in Computer Science
**Current GPA:** 4.17 / 4.3 (Semester 1)
**Key Grades:** * Fundamental Computer Programming: 96 (A+)
* Calculus: 90.8 (A+)
* English for Academic Purposes: 95.9 (A+)
